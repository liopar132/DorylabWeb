      ...
      <div className='container mx-auto'>
        ...
        <div className='container mx-auto w-fit flex flex-col gap-4 items-center pt-5'>
            ...
            <div className='flex flex-row gap-10'>
                <a target="_blank" href='https://www.facebook.com/dorylabmaroc/'><Instagram fontSize='large' color='white'/></a>
                <a target="_blank" href='https://www.facebook.com/dorylabmaroc/'><Facebook fontSize='large' color='white'/></a>
                <a target="_blank" href='https://www.facebook.com/dorylabmaroc/'><Google fontSize='large' color='white'/></a>
            </div>
